...
from PhanVM import EventDecoder
...
def parseEventTx(hash):
	...
	if 'result' in tx:
		for event in tx['events']:
			...
			print("DECODED DATA:", tokensymbol, nft_id_or_tokenamount, "\n")

if __name__ == '__main__':

	#EXAMPLE TX WITH FT 
	print ("############## FT TX ############## ")
	parseEventTx("2C55319B7B8A57B31CA41EA8517E5A970A6C20885ED2B85053137B8393BB03AA")
	print ("############## FT TX ############## ")

	#EXAMPLE TX WITH NFT 
	print ("############## FT TX ############## ")
	parseEventTx("9DA4489D589E4B8FA3AB46FBA25ED0086EF4808DC4EC8C888FC3B4D3715BAE07")
	print ("############## FT TX ############## ")
